...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Birth Application : Backend Application Api",
				"This project is developed by Munna Sharma", "1.0", "Terms of Service",
				new Contact("Munna Rana","7667229002" ,"munna.ranaa1@gmail.com"),
